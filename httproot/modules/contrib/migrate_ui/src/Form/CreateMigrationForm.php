...
class CreateMigrationForm extends MigrationEntityFormBase {
  ...
  public function form(array $form, FormStateInterface $form_state, MigrationInterface $migration = NULL) {
    ...
    $form['configuration']['source'] = [
      ...
      '#ajax' => array(
        'callback' => [$this, 'ajaxUpdateMigrateConfig'],
    ...
    $form['configuration']['destination_entity_type'] = [
      ...
      '#submit' => [$this, 'ajaxUpdateEntityTypeSubmit'],
      '#ajax' => array(
        'callback' => [$this, 'ajaxUpdateEntityTypeCallback'],
   ...
   */
  public function ajaxUpdateEntityTypeSubmit(&$form, FormStateInterface $form_state) {
   ...
   */
  public function ajaxUpdateEntityTypeCallback($form, FormStateInterface $form_state) {
    return $form;
  }
   ...
   */
  public function ajaxUpdateMigrateConfig($form, FormStateInterface $form_state) {
  ...
  protected function processMigrationValues(MigrationInterface $migration, $form_state_values) {
    ...
    // @todo, remove this workaround once https://drupal.org/node/2629374 is
    // fixed.
