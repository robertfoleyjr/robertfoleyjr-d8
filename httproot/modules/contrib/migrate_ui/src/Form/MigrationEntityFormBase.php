...
class MigrationEntityFormBase extends EntityForm {
   ...
   */
  public function __construct(EntityFieldManagerInterface $entity_field_manager, MigratePluginManager $source_plugin_manager, MigratePluginManager $process_plugin_manager) {
