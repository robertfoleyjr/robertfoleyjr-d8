...
class SchemaFormBuilder implements SchemaFormBuilderInterface {
   ...
   *   The form state of the form the subtree is attached to, for AJAX reasons.
   */
  protected function typeHandler(array $schema, $context, &$form, FormStateInterface $form_state) {
   ...
   *   The form state of the form the subtree is attached to, for AJAX reasons.
   */
  protected function mappingHandler(array $schema, $context, &$form, FormStateInterface $form_state) {
   ...
   *   The form state of the form the subtree is attached to, for AJAX reasons.
   */
  protected function sequenceHandler(array $schema, $context, &$form, $form_state) {
   ...
   */
  protected function uniqueAjaxId(array $schema, $context) {
