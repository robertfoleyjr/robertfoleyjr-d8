...
/**
 * @file
 * Contains Drupal\Tests\migrate_source_json\Unit\Plugin\migrate\source\JSONSourceTest
 */
 ...
 */
class JSONSourceTest extends JSONUnitTestCase {
  ...
  public function setUp() {
    ...
    $this->source = new JSONSource($this->configuration, $this->pluginId, $this->pluginDefinition, $this->plugin);
  ...
  public function migrateExceptionPathMissing() {
    ...
    new JSONSource($configuration, $this->pluginId, $this->pluginDefinition, $this->plugin);
  }
  ...
  public function initializeIterator() {
    ...
    $source = new JSONSource($configuration, $this->pluginId, $this->pluginDefinition, $this->plugin);
